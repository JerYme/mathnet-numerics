...
{
    /// <summary>
    /// https://github.com/raminrahimzada/CSharp-Helper-Classes/blob/master/Math/DecimalMath/DecimalMath.cs
    /// </summary>
    public static class DecimalMath
    {
        ...
        public static decimal Ceiling(decimal x) => (int)(x + 1 - Epsilon);

        public static decimal Floor(decimal x) => (int)x;

        public static decimal Round(decimal x) => (int)x;

        public static decimal Truncate(decimal x) => (int)x;

        public static decimal Abs(decimal x) => x < 0m ? -x : x;
